    ...
    <div className="mt-16 w-full max-w-2xl">
        ...
        <div className="space-y-4 text-left">
            <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">What does this AI brand budgeting tool do?</h4>
                <p className="text-gray-600 text-sm mt-1">
                    The AI analyzes your brand goals, priorities, and total budget to recommend a
customized budget breakdown across branding, marketing, advertising, and more.
                </p>
            </div>
            <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">How accurate is the brand budget recommendation?
</h4>
                <p className="text-gray-600 text-sm mt-1">
The AI provides data-backed recommendations based on industry benchmarks,
your inputs, and real-time optimization logic. It’s meant to guide strategic
decisions, not replace human expertise.                </p>
            </div>
            <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">Is this tool suitable for startups or large businesses?</h4>
                <p className="text-gray-600 text-sm mt-1">
Yes, the AI is scalable and can generate tailored budgets for startups, SMEs, or
large enterprises.                </p>
            </div>

                        <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">What areas of brand building does the budget cover?</h4>
                <p className="text-gray-600 text-sm mt-1">
It typically includes brand strategy, visual identity, packaging, content creation,
digital marketing, influencer marketing, website development, PR, and media
buying.                </p>
            </div>

            <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">Can I prioritize certain aspects on focus areas, e.g. digital marketing or
packaging?</h4>
                <p className="text-gray-600 text-sm mt-1">
Yes, you can indicate your focus areas, and the AI will adjust the allocation
accordingly.               </p>
            </div>

                <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">Does the tool recommend a monthly or annual budget split?</h4>
                <p className="text-gray-600 text-sm mt-1">
                You can choose either. The AI will break down the budget accordingly.
               </p>
            </div>

                            <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">What information do I need to provide to get my brand budget?
</h4>
                <p className="text-gray-600 text-sm mt-1">
You'll be asked for your total available budget, business goals, industry, brand
stage (new, growing, mature), target audience, and your focus areas.
               </p>
            </div>

                                        <div className="border p-4 rounded-lg shadow-sm bg-white">
                <h4 className="font-medium text-gray-900">Can I revise my inputs later if my budget or priorities change?

</h4>
                <p className="text-gray-600 text-sm mt-1">
Absolutely. You can update your inputs anytime and get a fresh recommendation.
               </p>
            </div>
