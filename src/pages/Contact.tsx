              ...
              <div className="space-y-8 mt-12">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@mibbs.in" className="text-accent hover:underline">hello@mibbs.in</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="#" className="text-accent hover:underline">Scan our QR code</a>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card hover:-translate-y-2">
              ...
              <Button variant="outline" className="w-full">Explore Solutions</Button>
            </div>
            ...
            <div className="card hover:-translate-y-2">
              ...
              <Button variant="outline" className="w-full">Media Inquiries</Button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-white text-accent hover:bg-gray-100 font-semibold py-3 px-6 rounded-md transition-all duration-300">
                Try MIBBS Free
              </Button>
