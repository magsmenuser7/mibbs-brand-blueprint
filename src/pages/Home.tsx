...
const Home = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-white to-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-navy mb-6">
                Smarter Budgets. <br />
                <span className="text-accent">Stronger Brands.</span>
              </h1>
              ...
              <div className="relative">
                <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-lg">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <Button variant="ghost" size="sm" className="flex items-center text-navy">
                      <Download size={18} className="mr-1" /> Export
                    </Button>
                  </div>
                  <div className="space-y-6">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-center justify-center h-40 bg-gradient-to-r from-accent-light to-accent rounded-md">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold mb-3 text-navy">Guesswork Elimination</h3>
            ...
            <div className="card hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold mb-3 text-navy">Market Specificity</h3>
              <p className="text-navy-light">
            ...
            <div className="card hover:-translate-y-2">
              ...
              <h3 className="text-xl font-semibold mb-3 text-navy">Strategic Alignment</h3>
              <p className="text-navy-light">
      ...
      <section className="py-20 bg-gray-50" id="what-mibbs-solves">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="section-title">What MIBBS<span className="text-accent text-sm align-super">™</span> Solves</h2>
            <p className="section-subtitle">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="bg-white rounded-xl shadow-lg p-8 relative">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-accent-light to-accent"></div>
      ...
      <section className="py-20 bg-navy text-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-accent-light text-5xl font-serif mb-6">"</div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="font-bold text-lg">Sandeep Kumar</p>
                <p className="text-accent-light">Founder, MIBBS & Magsmen</p>
              </div>
            </div>
          </div>
        </div>
