    ...
    const generatePDF = async () => {
      ...
      <html>
        ...
        <body>
          <div class="header">
            <div>
                <img src="/logo-mibbs.png" alt="MIBBS Logo" style="width: 120px;">
            </div>
            <div>
...
const sendEmail = (formData: any) => {
  ...
  return emailjs.send(
    ...
    const onUnlockSubmit = async (data: UnlockFormData) => {
        debugger;
        console.log('Unlock form data:', data);
        console.log('full form data', formData)
        // alert("sucessfully sending a email ")
        // setIsUnlocked(true);
        try {
