...
import BudgetChatbot from '../chatbot/BudgetChatbot';
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button 
              ...
              className="flex items-center space-x-2 px-6 py-3 bg-mibbs-gradient text-white rounded-lg font-medium hover:opacity-90 transition-all"
            >
              <span>Ask Questions About My Budget</span>
            </button>
            <button 
