                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 text-sm text-gray-600">
                      ...
                      <div>
                        <span className="font-medium">Agency:</span> {approval.agency}
                      </div>
                      <div>
                        <span className="font-medium">Region:</span> {approval.region}
                      </div>
                      <div>
                        <span className="font-medium">Submitted:</span> {approval.submittedAt}
                      </div>
                    </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {assets.map((asset) => (
                    <tr key={asset.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{asset.uploadedBy}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{asset.uploadedAt}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{asset.downloads}</td>
