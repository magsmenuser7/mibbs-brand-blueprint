    ...
    <div className="space-y-6 px-4 sm:px-6 md:px-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
        ...
        <div className="mt-4 sm:mt-0 flex flex-wrap gap-3">
          <button className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center w-full sm:w-auto justify-center">
            <Download className="w-4 h-4 mr-2" />
            Export
          </button>
          <button className="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center w-full sm:w-auto justify-center">
            ...
            <div key={index} className={`relative border-2 rounded-xl p-6 ${
              ...
              <div className="text-center mb-6">
                ...
                <div className="mb-4">
                  ...
                  <span className="text-gray-600 ml-2 block sm:inline">for {pkg.credits} credits</span>
                </div>
      ...
      <div className="bg-white rounded-xl shadow-sm">
        <div className="p-6 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button className="flex items-center px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors w-full sm:w-auto justify-center">
            ...
            <tbody>
              {transactions.map((transaction) => (
                <tr key={transaction.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="p-6 capitalize text-sm text-gray-600">{transaction.type}</td>
                  <td className="p-6">
