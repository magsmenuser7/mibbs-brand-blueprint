...
const Messages: React.FC = () => {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col sm:flex-row bg-white rounded-xl shadow-sm overflow-hidden">

      {/* Conversations List */}
      <div className={`sm:w-1/3 w-full border-r border-gray-200 flex flex-col 
        ${selectedChat && window.innerWidth < 640 ? 'hidden' : 'block'}`}>
        ...
        <div className="flex-1 overflow-y-auto">
          {conversations.map((conversation) => (
            <div
              ...
              className={`p-4 sm:p-5 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors ${
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mb-1">{conversation.contact}</p>
          ...
          <>
            ...
            <div className="p-4 sm:p-6 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="font-semibold text-gray-900 text-sm sm:text-base">{selectedConversation.name}</h2>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 bg-gray-50">
              {messages.map((message) => (
                ...
                >
                  <div className={`max-w-[80%] sm:max-w-md px-3 sm:px-4 py-2 rounded-lg ${
            ...
            {/* Quick Replies */}
            <div className="px-4 sm:px-6 py-2 border-t border-gray-100 bg-white">
              <div className="flex space-x-2 overflow-x-auto">
                {quickReplies.map((reply, index) => (
                  <button
                    key={index}
                    onClick={() => setNewMessage(reply)}
                    className="flex-shrink-0 px-3 py-1 text-xs sm:text-sm bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition-colors"
                  >
                    {reply}
                  </button>
                ))}
              ...
              <div className="flex items-end space-x-3">
                <div className="flex-1 border border-gray-300 rounded-lg overflow-hidden">
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2 sm:px-4 sm:py-3 border-0 resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                    onKeyPress={(e) => {
                  ...
                  />
                  <div className="flex items-center justify-between px-3 sm:px-4 py-2 border-t border-gray-200">
                    ...
                    <button
                      ...
                      className="flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm sm:text-base"
                    >
