...
import { Plus, Search, Star, MapPin, MessageCircle, Phone, Mail, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-gray-900">Top Agencies Involved</h2>
          <p className="text-gray-600 mt-1">Agencies near you that handle budgets like yours</p>
        </div>
          ...
          <div key={agency.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
                    ...
                    <span>{agency.location} • {agency.distance} away</span>
                  </div>
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-gray-500">Avg budget: {agency.avgBudgetHandled}</p>
              </div>
            </div>
