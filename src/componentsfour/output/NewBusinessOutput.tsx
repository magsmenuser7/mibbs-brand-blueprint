      ...
      <div ref={pdfContentRef} className="max-w-[850px] mx-auto bg-white shadow-lg">
        ...
        <div className="bg-white border-b border-gray-100 py-5 px-8 flex items-center justify-center gap-3">
          ...
          <div className="text-left">
            <h1 className="text-lg font-bold text-[#1E293B] tracking-tight">New Business Launch Report</h1>
        ...
        <div className="px-8 py-6">
          <h3 className="text-lg font-bold text-[#1E293B] mb-6">Budget Allocation & Recommended Channels</h3>
          <div className="grid grid-cols-2 gap-8">
            <div>
              <h4 className="text-sm font-semibold text-[#4F46E5] mb-4">Capital Distribution</h4>
              <div className="flex items-center justify-center">
                <DonutChart />
              </div>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-[#4F46E5] italic mb-4">Recommended Channels</h4>
