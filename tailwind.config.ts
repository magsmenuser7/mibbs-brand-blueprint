  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        /* option system */
        "option-selected": {
          DEFAULT: "hsl(var(--option-selected))",
          bg: "hsl(var(--option-selected-bg))",
        },

        "option-hover": "hsl(var(--option-hover))",

        "step-inactive": "hsl(var(--step-inactive))",
        "step-complete": "hsl(var(--step-complete))",
      ...
      backgroundImage: {
        "mibbs-gradient":
          "linear-gradient(135deg, #6B46C1 0%, #8B5CF6 50%, #EC4899 100%)",
        "mibbs-gradient-light":
